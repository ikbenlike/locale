...
/**
 ** \file inc/bison_charmap.hpp
 ** Define the charmap_parser::parser class.
 */
...
#ifndef YY_CHARMAP_PARSER_INC_BISON_CHARMAP_HPP_INCLUDED
# define YY_CHARMAP_PARSER_INC_BISON_CHARMAP_HPP_INCLUDED
...
/* Debug traces.  */
#ifndef CHARMAP_PARSERDEBUG
# if defined YYDEBUG
#if YYDEBUG
#   define CHARMAP_PARSERDEBUG 1
#  else
#   define CHARMAP_PARSERDEBUG 0
#  endif
# else /* ! defined YYDEBUG */
#  define CHARMAP_PARSERDEBUG 1
# endif /* ! defined YYDEBUG */
#endif  /* ! defined CHARMAP_PARSERDEBUG */

namespace charmap_parser {
#line 190 "inc/bison_charmap.hpp"
  ...
  {
  public:
#ifdef CHARMAP_PARSERSTYPE
# ifdef __GNUC__
#  pragma GCC message "bison: do not #define CHARMAP_PARSERSTYPE in C++, use %define api.value.type"
# endif
    typedef CHARMAP_PARSERSTYPE value_type;
#else
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    struct token
    {
      ...
      {
        CHARMAP_PARSEREMPTY = -2,
    CHARMAP_PARSEREOF = 0,         // "end of file"
    CHARMAP_PARSERerror = 256,     // error
    CHARMAP_PARSERUNDEF = 257,     // "invalid token"
    CONFIG = 258,                  // CONFIG
    ...
    END = 267,                     // END
    RANGE = 268,                   // RANGE
    RANGE_GNU = 269,               // RANGE_GNU
    WIDTH = 270,                   // WIDTH
    WIDTH_DEFAULT = 271            // WIDTH_DEFAULT
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_CHARACTER_HEX = 5,                     // CHARACTER_HEX
        S_CHARACTER_DEC = 6,                     // CHARACTER_DEC
        S_CHARACTER_OCT = 7,                     // CHARACTER_OCT
        S_NUMBER = 8,                            // NUMBER
        S_EOL = 9,                               // EOL
        S_TEXT = 10,                             // TEXT
        S_CHARMAP = 11,                          // CHARMAP
        S_END = 12,                              // END
        S_RANGE = 13,                            // RANGE
        S_RANGE_GNU = 14,                        // RANGE_GNU
        S_WIDTH = 15,                            // WIDTH
        S_WIDTH_DEFAULT = 16,                    // WIDTH_DEFAULT
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_CHARMAP_PARSEREOF ()
      {
        return symbol_type (token::CHARMAP_PARSEREOF);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_CHARMAP_PARSERerror ()
      {
        return symbol_type (token::CHARMAP_PARSERerror);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_CHARMAP_PARSERUNDEF ()
      {
        return symbol_type (token::CHARMAP_PARSERUNDEF);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_CHARACTER_HEX (uint8_t v)
      {
        return symbol_type (token::CHARACTER_HEX, std::move (v));
      }
#else
      static
      symbol_type
      make_CHARACTER_HEX (const uint8_t& v)
      {
        return symbol_type (token::CHARACTER_HEX, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CHARACTER_DEC (uint8_t v)
      {
        return symbol_type (token::CHARACTER_DEC, std::move (v));
      }
#else
      static
      symbol_type
      make_CHARACTER_DEC (const uint8_t& v)
      {
        return symbol_type (token::CHARACTER_DEC, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CHARACTER_OCT (uint8_t v)
      {
        return symbol_type (token::CHARACTER_OCT, std::move (v));
      }
#else
      static
      symbol_type
      make_CHARACTER_OCT (const uint8_t& v)
      {
        return symbol_type (token::CHARACTER_OCT, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_NUMBER (uint8_t v)
      {
      ...
      make_CHARMAP ()
      {
        return symbol_type (token::CHARMAP);
      }
#else
      static
      symbol_type
      ...
      make_RANGE_GNU ()
      {
        return symbol_type (token::RANGE_GNU);
      }
#else
      static
      symbol_type
      ...
      make_WIDTH ()
      {
        return symbol_type (token::WIDTH);
      }
#else
      static
      symbol_type
      ...
      make_WIDTH_DEFAULT ()
      {
        return symbol_type (token::WIDTH_DEFAULT);
      }
#else
      static
      symbol_type
...
#endif // !YY_CHARMAP_PARSER_INC_BISON_CHARMAP_HPP_INCLUDED
